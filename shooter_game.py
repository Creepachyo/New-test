...
try:
    ...
    sys.exit('Не найдены файлы игры')
...
font.init()
main_font = font.SysFont('Arial', 40)
defeat_font = font.SysFont('Arial', 100)
defeat = defeat_font.render('Поражение', True, (255, 0, 0))
win_font = font.SysFont('Arial', 80)
...
while run:
    ...
    if finish == False:
        ...
        text_health = main_font.render(f'Здоровье:{health}', True, color)
